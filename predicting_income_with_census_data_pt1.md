...
_fill in temporary conclusion here_    
In Part 1 of this tutorial, we have explored the first half of the machine learning application pipeline: ...    
In Part 2 (coming soon), we'll demonstrate how to ...
